---
title: "Using Map Tiles to Visualize Spatial Data"
...
output:
  rmarkdown::html_vignette:
    ...
    self_contained: no
  vignette: >
    %\VignetteIndexEntry{Using Map Tiles to Visualize Spatial Data}
...
This vignette introduces the core functions in the **ggmaptile** R package.
To start, we load the package into R. We all load **dplyr** to assist with
processing our data.
